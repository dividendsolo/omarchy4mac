...
- [ ] **`omarchy-mac update`**: pull the repo, re-link, re-sync themes, restart services — the port's answer to `omarchy-update`. Keeps every adopter current with one command.
